...
class AssignMbpDialog extends StatefulWidget {
  final int mbpId;
  final String mbpNumber;

  const AssignMbpDialog({
    super.key,
    required this.mbpId,
  ...
  @override
  State<AssignMbpDialog> createState() => _AssignMbpDialogState();
}

class _AssignMbpDialogState extends State<AssignMbpDialog> {
  ...
  Future<void> _assignMbp() async {
    ...
    try {
      final result = await ApiService.assignMbp(
        widget.mbpId,
      ...
      if (!result['error']) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'MBP berhasil di-assign ke ${_selectedEngineer!.name}',
            ),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result['message'] ?? 'Gagal assign MBP'),
        ...
        child: Column(
          ...
          children: [
            ...
            if (_isLoadingEngineers)
              ...
              // Assign Button
              ElevatedButton(
                onPressed: _isAssigning ? null : _assignMbp,
...
Future<bool?> showAssignMbpDialog(
  BuildContext context, {
  required int mbpId,
  required String mbpNumber,
}) {
  return showDialog<bool>(
    context: context,
    builder: (context) => AssignMbpDialog(mbpId: mbpId, mbpNumber: mbpNumber),
  );
}
